        ...
        <div className='login-page'>
            <div className="login-left">
                <div className="body-register">
                    <div className="title-forgot"><div className="text-wrapper">Forgot Password</div></div>
                    <div className="text-wrapper-sub">Don't worry! This happens often. Please enter your email address, and we will send the OTP code to it. </div>
