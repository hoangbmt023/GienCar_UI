...
import SalesModal from "../components/ChatBox/SalesModal";
  ...
  const fetchData = async () => {
    try {
      ...
      if (state?.car) {
        ...
        setSelectedImage(state.car.images?.[0]?.url || state.car.image || "");
      ...
      const mappedCar = {
        ...
        co2:
          spec.consumption?.co2EmissionsGPerKm != null
            ...
            : "-",
        torque:
          spec.engine?.torqueNm != null ? `${spec.engine.torqueNm} Nm` : "-",
        ...
        wheelbase:
          spec.body?.wheelBaseMm != null ? `${spec.body.wheelBaseMm} mm` : "-",
      };
