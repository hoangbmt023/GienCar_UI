...
const menus = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Hãng xe", to: "/admin/thuong-hieu-xe" },
      { label: "Dòng xe", to: "/admin/dong-xe" },
  ...
  },
  {
    ...
    label: "Chi nhánh",
    icon: Building2,
    children: [{ label: "Quản lý chi nhánh", to: "/admin/chi-nhanh" }],
  },
  {
    id: "user",
    label: "Người dùng",
  ...
  return (
    <aside className={`Sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <div className="Sidebar__footer">
        <button className="Sidebar__item" onClick={() => navigate("/home")}>
          <span className="Sidebar__icon">
            <Home size={18} />
          </span>
          {!collapsed && <span className="Sidebar__label">Trang chủ</span>}
        </button>
