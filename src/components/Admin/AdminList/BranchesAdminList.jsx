...
import BranchesForm from "@/components/Admin/AdminForms/BranchesForm";
import RenderPagination from "@/components/Commons/RenderPagination/RenderPagination";

export default function BranchesAdminList() {
    ...
    const fetchData = useCallback(async (page = 1) => {
        try {
            const res = await adminService.branches.getAllForAdmin({
                page,
                size: 10
            });
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            await adminService.branches.delete(deleteTarget.id);
    ...
    const handleSubmitForm = async (data) => {
        ...
        try {
            ...
            if (!editing) {
                await adminService.branches.create(data);
            } else {
                await adminService.branches.update(editing.id, data);
            }
